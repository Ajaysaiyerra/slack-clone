...
export const Toolbar = ({ onMenuClick }: { onMenuClick?: () => void }) => {
  ...
  return (
    <nav className="flex h-10 items-center justify-between bg-[#481349] p-1.5">
      <div className="flex flex-1 items-center">
        {onMenuClick && (
          <Button onClick={onMenuClick} variant="transparent" size="iconSm" aria-label="Open menu">
            <Menu className="size-5 text-white" />
          </Button>
        )}
      </div>

      <div className="min-w-[140px] max-w-[642px] shrink grow-[2] sm:min-w-[280px]">
